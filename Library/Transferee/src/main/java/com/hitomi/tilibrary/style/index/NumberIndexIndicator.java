...
public class NumberIndexIndicator implements IIndexIndicator {
    ...
    public void attach(FrameLayout parent) {
        int dp50 = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP,
                50, parent.getContext().getResources().getDisplayMetrics()
        );
        FrameLayout.LayoutParams indexLp = new FrameLayout.LayoutParams(WRAP_CONTENT, dp50);
