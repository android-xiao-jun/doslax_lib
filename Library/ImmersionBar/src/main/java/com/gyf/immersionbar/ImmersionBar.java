...
public final class ImmersionBar implements ImmersionCallback {
    ...
    private void updateBarParams() {
        ...
        mBarParams.layoutFullscreen = true;
    }
    ...
    private int initBarAboveLOLLIPOP(int uiFlags) {
        ...
        if (mBarParams.layoutFullscreen) {
    ...
    public ImmersionBar statusBarColorInt(@ColorInt int statusBarColor) {
        ...
        mBarParams.layoutFullscreen = statusBarColor == Color.TRANSPARENT;
        return this;
    }
    ...
    public ImmersionBar statusBarColorInt(@ColorInt int statusBarColor,
        ...
        mBarParams.layoutFullscreen = statusBarColor == Color.TRANSPARENT || alpha == 0f;
        return this;
    }
    ...
    public ImmersionBar barColorInt(@ColorInt int barColor) {
        ...
        mBarParams.layoutFullscreen = barColor == Color.TRANSPARENT;
        return this;
    }
    ...
    public ImmersionBar barColorInt(@ColorInt int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        ...
        mBarParams.layoutFullscreen = barColor == Color.TRANSPARENT || barAlpha == 0f;
        return this;
    }
