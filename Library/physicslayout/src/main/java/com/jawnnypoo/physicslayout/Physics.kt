...
class Physics @JvmOverloads constructor(
    ...
    init {
        ...
        if (attrs != null) {
            ...
            topDownBounds = a.getBoolean(R.styleable.Physics_topDownBounds, topDownBounds)
            ...
            horizontalDrag = a.getBoolean(R.styleable.Physics_horizontalDrag, horizontalDrag)

            velocityIterations =
                a.getInt(R.styleable.Physics_velocityIterations, velocityIterations)
            positionIterations =
                a.getInt(R.styleable.Physics_positionIterations, positionIterations)
            pixelsPerMeter = a.getFloat(
                R.styleable.Physics_pixelsPerMeter, 50 * density
            )
            a.recycle()
        }else{
...
//        return true
    ...
    private fun m86408y() {
        ...
        this.bounds.add(createBound(w, h, R.id.physics_layout_bound_top, Bound.Side.TOP))
        this.bounds.add(createBound(w, h, R.id.physics_layout_bound_bottom, Bound.Side.BOTTOM))
    }
